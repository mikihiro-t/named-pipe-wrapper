...
namespace NamedPipeWrapper.Tests
{
    public class SerializableTests
    {
        ...
        public void TestCircularReferences()
        {
            ...
            //_actualHashがNotNullであることをテストするが、_actualHashはintなので、0でないとしてみた。
        ...
        public void TestStudy()
        {
            ...
            var byteArray = Binary.ObjectToByteArray(_expectedData);


            var data = Binary.ByteArrayToObject<TestCollection>(byteArray);

            Assert.True(_expectedHash == data.GetHashCode());
        }
    }
    ...
    class TestItem
    {
        ...
        /// <summary>
        /// https://zenn.dev/tk2345/articles/75ba9befb294b1
        /// </summary>
        public TestItem()
        {
        }
